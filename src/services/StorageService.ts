...
export class StorageService {
    ...
    public getProjectName(): string | null {
        ...
        const projectName = this._context.workspaceState.get(`projectName_${workspaceKey}`) as string | undefined;
    ...
    public getApiKey(): string | null {
        const apiKey = this._context.globalState.get('justJuggle_apiKey') as string | undefined;
        return apiKey || null;
    }
    ...
    public getApiEndpoint(): string {
        const customEndpoint = this._context.globalState.get('justJuggle_apiEndpoint') as string | undefined;
    ...
    public isDevelopmentMode(): boolean {
        const devMode = this._context.globalState.get('justJuggle_devMode') as boolean | undefined;
